					...
					<?php	
							...
							if ($_SERVER["REQUEST_METHOD"] == "POST") {
								...
								if (empty($_POST["thoigianhoc"])) {
									...
									if (!preg_match ("/^Thứ [1-7] tiết (1[0-5]|[1-9])-([2-9]|1[0-6])$/", $thoigianhoc) ) {
							...
							switch($_POST['nut'])
							{
								case'Save changes':
								{
									...
									if( $tenmhErr=='' && $thoigianhocErr=='' && $namhocErr  =='' )
									{
											...
											{
												echo'<script language="javascript">window.alert("Thêm môn học thành công");</script>';
																	
												echo '<script language="javascript">window.location="themmonhoc.php";</script>';
											}
											else
											{
												echo'Thêm môn học không thành công.';
												$thongbao='Thêm môn học không thành công.';
												$p->thongbao($thongbao,$link);
											}
									}
									else
									{
