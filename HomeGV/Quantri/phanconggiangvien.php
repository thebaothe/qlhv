      ...
      <div class="content-inner w-100">
          ...
          <div class="container-fluid">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0 py-3">
                ...
                <li class="breadcrumb-item active fw-light" aria-current="page">Phân công giảng viên</li>
              </ol>
            </nav>
          </div>
        </div>
              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <h3 class="h4 mb-0">Phân công giảng viên</h3>
                  </div>
                  <div class="card-body">
                  ...
                  <?php
							...
							// Định nghĩa biến 
							$hotengiangvienerr = $tenmonhocerr="";
							$hotengiangvien = $tenmonhoc= "";
							 
							//Input fields validation
							if ($_SERVER["REQUEST_METHOD"] == "POST") {
							 
							//Validate tên 
								if (empty($_REQUEST["id_giangvien"]))
								{
									$hotengiangvienerr = "Bạn chưa chọn giảng viên";
								}
                    ...
                    <form action="" method="post" class="form-horizontal"  >
                      <div class="row">
                        <label class="col-sm-3 form-label">Danh sách giảng viên</label>
                        <div class="col-sm-9">
                            <?php
							$p->load_ds_giangvien_selectd("select id_giangvien, hoten from giangvien");
							?>
                      ...
                      <div class="row">
                        <label  class="col-sm-3 form-label">Danh sách lớp học phần</label>
                        <div class="col-sm-9">
		...
		switch($_POST['nut'])
		{
			case'Phân công':
			{
				...
				$tengiangvien=$_REQUEST['id_giangvien'];
				$tengiangvien=$p->decrypt($tengiangvien,'key123');
                ...
                if( $hotengiangvienerr=='' && $tenmonhocerr==''  )
				{

						if($p->themxoasua("INSERT INTO lophoc_gv (id_monhoc, id_giangvien) VALUES ($tenmonhoc,$tengiangvien );")==1)
						{
							echo'Phân công thành công.';
						}
						else
						{
							echo'Phân công không thành công..';
							echo $tenmonhoc , $hotengiangvien;
						}
				}
                else
                {
                  ...
                  <div class="card mb-0">
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
 							<?php
								$p->load_ds_phancong("SELECT giangvien.hoten, monhoc.tenmh,lophoc_gv.id FROM giangvien JOIN lophoc_gv ON giangvien.id_giangvien = lophoc_gv.id_giangvien JOIN monhoc ON monhoc.id_monhoc = lophoc_gv.id_monhoc LIMIT 0,25;");
							?>
