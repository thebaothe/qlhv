...
$id_monhoc=str_replace(array ("http://","https://"),"",$id_monhoc);
$id_monhoc=str_replace(array ("../","..\""),"",$id_monhoc);
$id_monhoc=$p->decrypt($id_monhoc,'key123');	
error_reporting(0); 
          ...
          <div class="container-fluid">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0 py-3">
                ...
                <li class="breadcrumb-item active fw-light" aria-current="page">Nộp bài</li>
              </ol>
            </nav>
          </div>
        </div>
					 ...
					 <?php
                        ...
                        switch($_POST['nut'])
                        {
                            case'Thêm':
                            {
                                ...
                                if($name !='' && $tenfile !='' &&  $ngaydang !=''  && ($type=='application/x-zip-compressed'|| $type =='application/octet-stream') &&  in_array($_uploaded_ext,$allowed_ext)  )
                                ...
                                {          $name=$_SESSION['id']."_".$name;
                                            if($p->uploadfile($name,$tmp_name,"folder")==1)
                                            {
                                                ...
                                                {
                                                   $thongdiep='Upload file thành công.';
													$p->thongbao($thongdiep);
													...
													$p->thongbao($thongdiep1);
													
                                                }
                                            }
                                            else
                                            {
												$thongdiep2='Upload file  thất bại.';
												$p->thongbao($thongdiep2);
                                ...
                                {
									$thongdiep3='Vui lòng nhập đầy đủ thông tin ';
									$p->thongbao($thongdiep3);
