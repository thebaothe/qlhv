                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" id="myfm">
                      ...
                      <div class="row">
                        <label class="col-sm-3 form-label">Nội dung muốn hỏi</label>
                        <div class="col-sm-9">
                      ...
                      <div class="border-bottom my-5 border-gray-200"></div>
                      <div class="row">
                        <label class="col-sm-3 form-label">Nội dung trả lời</label>
                        <div class="col-sm-9">
                          <textarea id="noidung" class="form-control" name="noidung_traloi"   rows="5" ><?php echo $p->laycot("SELECT noidung FROM traloi WHERE id_traloi='$id_traloi' LIMIT 1;"); ?></textarea>
                        </div>
                      </div>
					 ...
					 <?php
                        ...
                        switch($_POST['nut'])
                        {
                            case'Thêm':
                            {
								...
								{
									if($p->themxoasua("INSERT INTO thaoluan ( ten_binhluan, binhluan,id_taikhoan) VALUES ( '$tennguoidung', '$noidung','$id_taikhoan');")==1)
									{
                   ...
                   <?php
				    $id_taikhoan=$_SESSION['id'];
				   	$p->load_thaoluan("select * from thaoluan where id_taikhoan='$id_taikhoan' || id_taikhoan IN (SELECT id_taikhoan FROM taikhoan WHERE phanquyen ='giảng viên') ;");
